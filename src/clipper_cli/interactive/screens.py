...
def show_welcome(version: str, license_status: str) -> None:
    ...
    # Subtitle
    subtitle = Text()
    subtitle.append("🎬 Cut Long Videos into Viral Clips using AI\n\n", style="dim")
    subtitle.append(f"Version: ", style="dim")
    subtitle.append(f"v{version}", style="cyan")
    subtitle.append(" | ", style="dim")
    subtitle.append(f"License: ", style="dim")
    subtitle.append(license_status, style="green" if "✅" in license_status else "red")
...
def show_activation_screen() -> None:
    ...
    message = Text()
    message.append("\n\n")
    message.append("🔑 LICENSE ACTIVATION\n\n", style="bold yellow")
...
def show_processing_header(video_name: str) -> None:
    ...
    console.print(f"\n[bold cyan]🎬 Processing: [white]{video_name}[/white][/bold cyan]\n")
...
def show_clip_results(clips: list, output_dir: str) -> None:
    ...
    console.print("\n[bold cyan]✂️  Generated Clips[/bold cyan]\n")
    ...
    console.print(table)
    console.print(f"\n[green]✅ Clips saved to:[/green] [cyan]{output_dir}[/cyan]\n")
